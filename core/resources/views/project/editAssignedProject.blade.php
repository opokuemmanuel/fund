                ...
                <div class="col-xl-10">
                    <div class="row">
                        <div class="col-xl-9 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">Assigned Supervisor</h5>
                                <div id="app">
                                    @if(!empty($successMsg))
                                ...
                                <div class="card-body">
                                    <form method="post" action="{{route('Update_assignedProject')}}" enctype="multipart/form-data">
                                        @csrf

                                        <input type="hidden" class="form-control"  value="{{$arr->project_id}}" placeholder="name" name="project_id">

                                        <div class="form-group">
                                            <input type="text" class="form-control" disabled required value="{{$arr->user_id}}" placeholder="name" name="name">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control" disabled required value="{{$arr->username}}" placeholder="staff_id" name="staff_id">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control" disabled required value="{{$arr->budget}}" placeholder="staff_id" name="staff_id">
                                        </div>

                                        <div class="form-group">
                                            <select required class="form-control" name="supervisor">
                                                <option disabled>Select Supervisor</option>
                                                <option>{{$arr->supervisor_id}}</option>
                                                @foreach($all as $all_super)
                                                <option>{{$all_super->ids}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <select required class="form-control" name="status">
                                                ...
                                                <option>{{$arr->status}}</option>
                                                    <option>enabled</option>
                                                    <option>disabled</option>
                                            </select>
                                        </div>
{{--                                        <div class="form-group">--}}
{{--                                            <input type="text" required class="form-control" value="{{$arr->status}}" placeholder="house no." name="status">--}}
{{--                                        </div>--}}
                                        <div class="form-group">
                                            <input type="text" required class="form-control" disabled value="{{$arr->created_at}}" placeholder="place of work" name="work">
                                        </div>
