                                ...
                                <div class="card-body">
                                    <form method="post" action="{{route('update')}}" enctype="multipart/form-data">
                                        @csrf
                                            ...
                                            <input type="hidden" class="form-control" value="{{$arr->ids}}" placeholder="name" name="ids">

                                        <div class="form-group">
                                            <input type="text" class="form-control" required value="{{$arr->name}}" placeholder="name" name="name">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control" required value="{{$arr->staff_id}}" placeholder="staff_id" name="staff_id">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <input type="text" required class="form-control" value="{{$arr->house_no}}" placeholder="house no." name="house_no">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" required class="form-control" value="{{$arr->work}}" placeholder="place of work" name="work">
                                        </div>

                                        <div class="form-group">
                                            <input type="text" required class="form-control" value="{{$arr->card}}" placeholder="enter id number" name="card_no">
                                        </div>
                                        <div class="form-group">
                                            <img height="270" width="470" src="{{ asset('/core/public/post/'. $arr->card_image) }}"><br><br>
                                            <input type="file" required class="form-control" placeholder="place of residence" name="card_image">
                                        </div>
                                        <div class="form-group">
                                            <img height="170" width="170" src="{{ asset('/core/public/post/'. $arr->photo) }}"><br><br>
                                        </div>
